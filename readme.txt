...
a plugin to create, modify and retrieve forms and manage submissions. form maker, form creator, create forms, form creation.

== Description ==

The purpose of this plugin is to provide blog admin with an interactive form to create, update and display forms throughout the site. Shortcode can be provided in whatever page one wishes to display the form. The shortcodes are provded in the Form Info tab. When creating the form you have the option to provide the landing page or a success message instead. If the landing page is left blank the form will display a success message up submission. You can create the following inputs: select, hidden, checkboxes, radios, textareas and submit buttons. You can also specify a notifcation email for the submission to be sent to. The code is clean and neat and modifiable an the interface in jQuery interactive.The form builder requires simple html knowledge such as what should go in in label name and value attributes. form maker, form creator, create forms, form creation.
